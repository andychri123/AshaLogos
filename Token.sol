...
contract Token is IERC20, Owned {
    ...
    constructor (string memory name, string memory symbol, address payable creator) public {
        _name     = name; // solium-disable-line uppercase
        _symbol   = symbol; // solium-disable-line uppercase
...
//    }
 ...
 //   }
    ...
    function mint(address _to, uint am) public returns (bool success) {
